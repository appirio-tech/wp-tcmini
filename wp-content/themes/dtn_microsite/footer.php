...
<div id="footer">
	<div id="footerInner">
       <a href="http://www.topcoder.com/" class="topcoderLogoMed"><img src="http://www.topcoder.com/asteroids/wp-content/themes/asteroids_microsite/i/tcLogoSmall.png" alt="" /></a>
	  <?php wp_nav_menu( 
        array(
          'container' => false,
          'theme_location' => '',
